...
en_stopwords = list(stopwords.words('english')) + [punc for punc in string.punctuation.split() if punc not in ['-']] + ["."]
...
class EnglishSentence:
    def __init__(self, text=None):
        ...
        self._words = [[word for word in sentence if word not in en_stopwords] for sentence in self._words_full]
        ...
        self._stems = [[stemmer.stem(word) for word in sentence] for sentence in self._words]
